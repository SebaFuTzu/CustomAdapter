...
public class Lista extends AppCompatActivity {
    ...
    //Adapter llena el list view con los datos del método obtenerLista
    public void llenarLista(){
        ListView lvItemsLista = (ListView) findViewById(R.id.lvItemsLista);
        ListaAdapter adapter = new ListaAdapter(this, obtenerLista(), lvItemsLista);
        lvItemsLista.setAdapter(adapter);
